...
import { OPC_TIPO_DATO } from '@models/template/enums/enum-tipo-dato.enum';
import { OPC_CAMPO } from '@models/template/enums/enum-tipo-campo.enum'
import { OPC_SELECCION } from '@models/template/enums/enum-tipo-seleccion.enum'
import { OPC_FECHA } from '@models/template/enums/enum-tipo-fecha.enum'
